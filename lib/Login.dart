  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        print(response.body);
        print(jsonDecode(response.body)['result']["assignedRoles"]);
        Login.bearerToken = jsonDecode(response.body)['result']['authtoken'];
        if (!jsonDecode(response.body)['result']["assignedRoles"]
            .contains('CUSTOMER')) {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
                builder: (context) => Dashboard(
                      ...
                      customerId: jsonDecode(response.body)['result']
                          ['customerId'],
                      userId: jsonDecode(response.body)['result']['id'],
                    )),
          );
        }
      } else {
